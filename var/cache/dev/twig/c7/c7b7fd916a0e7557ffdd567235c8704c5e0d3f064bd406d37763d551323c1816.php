...
/* blog/show.html.twig */
class __TwigTemplate_a85858f792157831c4de3a11e03974d1ecff97736fb20ddfa80981165618e1d5 extends \Twig\Template
{
    private $source;
    ...
    <h1>    ";
        ...
        echo "-";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 5, $this->source); })()), "category", [], "any", false, false, false, 5), "name", [], "any", false, false, false, 5), "html", null, true);
        echo "</h1>
    <p>";
        // line 6
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 6, $this->source); })()), "content", [], "any", false, false, false, 6), "html", null, true);
        echo "</p>
</main>
";
    ...
    {
        return array (  74 => 6,  68 => 5,  65 => 4,  56 => 3,  34 => 1,);
    }
...
{% endblock %}", "blog/show.html.twig", "/var/www/html/symfony/blog/queteBlog1/templates/blog/show.html.twig");
    }
}
