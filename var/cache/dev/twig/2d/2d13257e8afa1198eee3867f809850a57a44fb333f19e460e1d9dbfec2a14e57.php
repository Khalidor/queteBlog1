...
class __TwigTemplate_d627d1130e329e6ded2d3f6cdb2821310084aa05e1841d925a63beab5bd0218f extends \Twig\Template
{
    private $source;
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["categoryArticles"]) || array_key_exists("categoryArticles", $context) ? $context["categoryArticles"] : (function () { throw new RuntimeError('Variable "categoryArticles" does not exist.', 6, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["categoryArticle"]) {
            // line 7
            echo "    ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categoryArticle"], "id", [], "any", false, false, false, 7), "html", null, true);
            echo ": ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categoryArticle"], "title", [], "any", false, false, false, 7), "html", null, true);
            echo "<br>
    ";
            // line 8
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["categoryArticle"], "content", [], "any", false, false, false, 8), "html", null, true);
            echo "<br>
    ";
        }
